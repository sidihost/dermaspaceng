    ...
    treatments: [
      {
        ...
        priceFrom: 45000,
        description:
          "Thorough cleansing and extraction for clear, refreshed skin. Couple option available from ₦85,000.",
        popular: true,
  ...
  },
  {
    ...
    treatments: [
      ...
      },
      {
        ...
        priceFrom: 45000,
        description:
          "Exfoliating salt or sugar scrub followed by a detoxifying steam. Add a full hour of massage from ₦80,000.",
      ...
      },
      {
        ...
        priceFrom: 50000,
        description:
          "Stimulating coffee-grain scrub for firmer, smoother skin.",
      ...
      },
      {
        ...
        priceFrom: 65000,
        description:
          "Full hour of massage rounded out with a relaxing detox steam. Add a 30-min massage from ₦100,000.",
      ...
      },
      {
        ...
        priceFrom: 80000,
        description:
          "Traditional wood-therapy lymphatic drainage.",
    ...
    treatments: [
      {
        ...
        priceFrom: 120000,
        description:
          "A 3-session Deep Cleansing Facial course, prepaid. Choose whether it's 3 sessions for one person (across separate visits) or 3 people treated together in one visit.",
        concerns: ["course of treatment", "savings"],
        variants: [
          {
            id: "individual-3-sessions",
            label: "3 Sessions — 1 Person (separate visits)",
            duration: "60 mins",
            price: 120000,
          },
          {
            id: "group-of-3",
            label: "3 People — Together in One Visit",
            duration: "60 mins",
            price: 120000,
          },
        ],
      },
      {
        ...
        priceFrom: 140000,
        description:
          "A 3-session Acne Facial course, prepaid. Choose whether it's 3 sessions for one person (across separate visits) or 3 people treated together in one visit.",
      ...
      },
      {
        ...
        priceFrom: 250000,
        description:
          "A 6-session Deep Tissue Massage course, prepaid. Choose whether it's 6 sessions for one person (across separate visits) or 6 people treated together in one visit.",
        popular: true,
        concerns: ["course of treatment", "muscle pain"],
        variants: [
          {
            id: "individual-6-sessions",
            label: "6 Sessions — 1 Person (separate visits)",
            duration: "60 mins",
            price: 250000,
          },
          {
            id: "group-of-6",
            label: "6 People — Together in One Visit",
            duration: "60 mins",
            price: 250000,
          },
        ],
      },
      {
        ...
        priceFrom: 240000,
        description:
          "A 6-session Swedish Massage course, prepaid. Choose whether it's 6 sessions for one person (across separate visits) or 6 people treated together in one visit.",
        popular: true,
      ...
      },
      {
        ...
        priceFrom: 340000,
        description:
          "A 6-session 4-hands Swedish course, prepaid. Choose whether it's 6 sessions for one person (across separate visits) or 6 people treated together in one visit.",
      ...
      },
      {
        ...
        priceFrom: 370000,
        description:
          "A 6-session 4-hands DTM course, prepaid. Choose whether it's 6 sessions for one person (across separate visits) or 6 people treated together in one visit.",
        concerns: ["course of treatment", "muscle pain"],
        variants: [
          {
            id: "individual-6-sessions",
    ...
    treatments: [
      {
        ...
        duration: "30 mins",
        priceFrom: 17000,
        description: "Shaped eyebrow waxing. Male from ₦17,000.",
      ...
      },
      {
        ...
        duration: "30 mins",
        priceFrom: 15000,
        description: "Quick chin waxing. Male from ₦17,000.",
        concerns: ["facial grooming"],
      },
      {
        id: "upper-lip-wax",
      ...
      },
      {
        ...
        priceFrom: 7000,
        description:
          "Quick, comfortable underarm waxing. Male from ₦18,000. Hard wax option from ₦10,000 (25 mins).",
        popular: true,
      ...
      },
      {
        ...
        priceFrom: 15000,
        description:
          "Chest or neck waxing. Male from ₦20,000 (chest) / ₦15,000 (neck).",
      ...
      },
      {
        ...
        duration: "30 mins",
        priceFrom: 15000,
        description: "Back waxing (full from ₦15,000, half from ₦4,000). Male from ₦20,000.",
        concerns: ["hair removal", "men's grooming"],
      },
      {
        id: "full-face-wax",
      ...
      },
      {
        ...
        duration: "30 mins",
        priceFrom: 20000,
        description: "Complete arm hair removal. Male from ₦35,000.",
        concerns: ["hair removal"],
      },
      {
        id: "half-arm-wax",
        ...
        duration: "30 mins",
        priceFrom: 25000,
        description: "Half-arm waxing. Male from ₦25,000.",
        concerns: ["hair removal"],
      },
      {
        id: "full-leg-wax",
        ...
        duration: "30 mins",
        priceFrom: 30000,
        description: "Complete leg hair removal. Male from ₦50,000.",
        popular: true,
      ...
      },
      {
        ...
        duration: "45 mins",
        priceFrom: 40000,
        description: "Lower leg waxing. Male from ₦30,000.",
        concerns: ["hair removal"],
      },
      {
        id: "bum-belly-wax",
        ...
        priceFrom: 20000,
        description:
          "Bum or belly waxing. Male from ₦20,000 (bum) / ₦10,000 (belly).",
        concerns: ["hair removal"],
      },
      {
        id: "bikini-belly-wax",
        ...
        duration: "20 mins",
        priceFrom: 10000,
        description: "Bikini line paired with belly wax (from ₦10,000 / ₦5,000). Male from ₦30,000.",
        concerns: ["hair removal"],
      },
      {
      ...
      },
      {
        ...
        priceFrom: 22000,
        description:
          "Brazilian / Hollywood waxing (30–40 mins). Male from ₦45,000 / ₦50,000. Hard wax option from ₦40,000 (1 hour).",
        popular: true,
        concerns: ["intimate hair removal"],
      },
      {
        ...
        priceFrom: 35000,
        description:
          "Combo waxing service (from ₦35,000 / ₦38,000). Male from ₦60,000. Hard wax option from ₦55,000 (1 hour).",
      ...
      },
      {
        ...
        duration: "120 mins",
        priceFrom: 40000,
        description: "Complete body hair removal in one appointment. Male from ₦120,000.",
    ...
    treatments: [
      {
        ...
        duration: "30 mins",
        priceFrom: 45000,
        description: "Laser hair removal on chin or cheeks. Male from ₦55,000.",
      ...
      },
      {
        ...
        duration: "20 mins",
        priceFrom: 10000,
        description: "Discreet nostril hair laser treatment. Male from ₦20,000.",
        concerns: ["facial grooming"],
      },
      {
        id: "laser-uni-brow",
        ...
        duration: "20 mins",
        priceFrom: 10000,
        description: "Laser hair removal for the brow centre. Male from ₦90,000.",
        concerns: ["facial grooming"],
      },
      {
        id: "laser-half-face",
        name: "Half Face / Full Face Laser",
        duration: "30 mins",
        priceFrom: 20000,
        description: "Half-face or full-face laser hair removal. Male from ₦70,000.",
        concerns: ["facial grooming"],
      },
      {
        id: "laser-full-arm",
        ...
        duration: "60 mins",
        priceFrom: 80000,
        description: "Full arm laser hair removal. Male from ₦120,000.",
        popular: true,
        concerns: ["hair removal"],
      },
      {
      ...
      },
      {
        ...
        duration: "30 mins",
        priceFrom: 30000,
        description: "Underarm laser hair removal. Male from ₦120,000.",
        popular: true,
        concerns: ["hair removal"],
      },
      {
        ...
        duration: "30 mins",
        priceFrom: 100000,
        description: "Chest laser hair removal. Male from ₦120,000.",
        concerns: ["hair removal", "men's grooming"],
      },
      {
        id: "laser-nipples",
        ...
        duration: "30 mins",
        priceFrom: 45000,
        description: "Nipple-area laser. Male from ₦50,000.",
        concerns: ["hair removal"],
      },
      {
        id: "laser-full-back",
      ...
      },
      {
        ...
        duration: "45 mins",
        priceFrom: 60000,
        description: "Half back laser hair removal. Male from ₦45,000.",
        concerns: ["hair removal"],
      },
      {
        id: "laser-belly",
        ...
        duration: "45 mins",
        priceFrom: 60000,
        description: "Full belly laser hair removal. Male from ₦70,000.",
        concerns: ["hair removal"],
      },
      {
        id: "laser-half-belly",
        ...
        duration: "30 mins",
        priceFrom: 40000,
        description: "Half belly laser hair removal. Male from ₦50,000.",
        concerns: ["hair removal"],
      },
      {
        ...
        duration: "30 mins",
        priceFrom: 30000,
        description: "Bikini line laser hair removal. Male from ₦40,000.",
        concerns: ["intimate hair removal"],
      },
      {
        id: "laser-brazilian",
        ...
        duration: "30 mins",
        priceFrom: 40000,
        description: "Brazilian laser hair removal. Male from ₦40,000.",
        popular: true,
        concerns: ["intimate hair removal"],
      },
      {
      ...
      },
      {
        ...
        duration: "45 mins",
        priceFrom: 105000,
        description: "Butt cheek laser hair removal. Male from ₦125,000.",
        concerns: ["hair removal"],
      },
      {
        id: "laser-insep",
        ...
        duration: "45 mins",
        priceFrom: 60000,
        description: "Inner-thigh / insep laser hair removal. Male from ₦70,000.",
        concerns: ["hair removal"],
      },
      {
        id: "laser-full-leg",
      ...
      },
      {
        ...
        duration: "30 mins",
        priceFrom: 70000,
        description: "Half leg laser hair removal. Male from ₦70,000.",
        concerns: ["hair removal"],
      },
    ],
  },
  {
    ...
    treatments: [
      ...
      },
      {
        ...
        duration: "45 mins",
        priceFrom: 70000,
        description: "Chin and neck combo (promo). Male from ₦90,000.",
      ...
      },
      {
        ...
        duration: "75 mins",
        priceFrom: 120000,
        description: "Full arm and underarm combo (promo). Male from ₦145,000.",
        concerns: ["hair removal", "promo"],
      },
      {
      ...
      },
      {
        ...
        duration: "75 mins",
        priceFrom: 135000,
        description: "Underarm and Hollywood combo (promo). Male from ₦145,000.",
        concerns: ["intimate hair removal", "promo"],
      },
    ],
  },
  ...
  },
  {
    ...
    treatments: [
      ...
      },
      {
        ...
        priceFrom: 160000,
        description:
          "Couple 1hr Deep Tissue / Swedish Massage + Deep Cleansing Facial. Was ₦165,000.",
      ...
      },
      {
        ...
        priceFrom: 110000,
        description:
          "1hr Deep Tissue / Swedish Massage OR Detox Bodyscrub & Steam + Deep Cleansing Facial + Mani-Pedi or Wax worth ₦25,000. Was ₦120,000.",
        popular: true,
        concerns: ["package", "self-care day"],
      },
      {
        ...
        priceFrom: 210000,
        description:
          "Couple 1hr Deep Tissue / Swedish Massage OR Detox Bodyscrub & Steam + Deep Cleansing Facial + Mani-Pedi or Wax worth ₦25,000. Was ₦225,000.",
        concerns: ["package", "couple", "self-care day"],
      },
      {
        ...
        priceFrom: 150000,
        description:
          "1hr Deep Tissue / Swedish Massage + Detox Bodyscrub & Steam + Deep Cleansing Facial + Mani-Pedi or Wax worth ₦25,000. Was ₦165,000.",
        popular: true,
      ...
      },
      {
        ...
        priceFrom: 290000,
        description:
          "Couple 1hr Deep Tissue / Swedish Massage + Detox Bodyscrub & Steam + Deep Cleansing Facial + Mani-Pedi or Wax worth ₦25,000. Was ₦315,000.",
