        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="bg-white rounded-xl border border-gray-100 p-3 mb-4">
            <div className="flex items-center justify-between relative">
              {/* Progress Line */}
              <div className="absolute top-4 left-0 right-0 h-0.5 bg-gray-100 mx-12" />
              <div 
                className="absolute top-4 left-0 h-0.5 bg-[#7B2D8E] mx-12 transition-all duration-500"
              ...
              {[
                ...
                <div key={s.num} className="flex flex-col items-center relative z-10">
                  <div className={`
                    w-8 h-8 rounded-full flex items-center justify-center font-medium text-xs transition-all duration-300
                    ${step > s.num 
                      ? 'bg-[#7B2D8E] text-white' 
                      : step === s.num 
                        ? 'bg-[#7B2D8E] text-white ring-2 ring-[#7B2D8E]/20' 
                        : 'bg-gray-100 text-gray-400'
                    }
                  `}>
                    {step > s.num ? <Check className="w-4 h-4" /> : s.num}
                  </div>
                  <span className={`text-[10px] font-medium mt-1.5 ${step >= s.num ? 'text-[#7B2D8E]' : 'text-gray-400'}`}>
                    {s.label}
                  </span>
                </div>
              ))}
                  ...
                  <div className="bg-white rounded-xl border border-gray-100 p-2">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-3 py-2.5 bg-gray-50 border-0 rounded-lg text-sm text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-[#7B2D8E]/20 focus:bg-white transition-all"
                      />
                      {searchQuery && (
                        <button
                ...
                <div className="space-y-3">
                  ...
                  {step === 1 && (
                    <button
                      ...
                      className="w-full py-3 px-4 bg-[#7B2D8E] text-white text-sm font-medium rounded-lg hover:bg-[#6B2278] transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                    >
                      Continue
                      <ChevronRight className="w-4 h-4" />
                    </button>
                  ...
                  {step === 3 && (
                    <button
                      ...
                      className="w-full py-3 px-4 bg-[#7B2D8E] text-white text-sm font-medium rounded-lg hover:bg-[#6B2278] transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                      {isSubmitting ? (
                        <>
