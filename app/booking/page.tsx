...
import { Calendar, Check, Bell, Clock, ArrowRight, Sparkles } from 'lucide-react'
  ...
  return (
    <div className="grid grid-cols-2 gap-2.5">
      <a
        ...
        className="inline-flex items-center justify-center gap-2 px-3 py-2.5 bg-[#25D366] text-white text-[13px] font-semibold rounded-xl hover:bg-[#1FB855] transition-colors"
      >
