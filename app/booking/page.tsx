          ...
          <div className="w-full px-0 sm:px-4 lg:px-6">
            ...
            <div className="max-w-4xl mx-auto mb-6 px-4">
              <Link 
                ...
                className="flex items-center justify-between p-4 bg-gradient-to-r from-[#7B2D8E]/10 to-[#D4A853]/10 rounded-2xl border border-[#7B2D8E]/20 hover:border-[#7B2D8E]/40 transition-all group"
              >
                ...
                <div className="flex items-center gap-2 text-[#7B2D8E] text-sm font-medium">
