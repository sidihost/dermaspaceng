...
export default function ForgotPasswordPage() {
  ...
  if (isSuccess) {
    return (
      <div className="bg-white lg:min-h-screen lg:flex">
        ...
        <div className="px-5 py-8 lg:flex-1 lg:flex lg:items-center lg:justify-center lg:p-8">
  ...
  return (
    <div className="bg-white lg:min-h-screen lg:flex">
      ...
      <div className="px-5 py-6 lg:flex-1 lg:flex lg:items-center lg:justify-center lg:p-8">
