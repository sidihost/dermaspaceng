                  ...
                  <div className="bg-gradient-to-br from-[#7B2D8E] to-[#5A1D6A] rounded-2xl p-5 md:p-6 text-white">
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1">
                        <h3 className="font-semibold text-base mb-1">Need help, {user?.firstName}?</h3>
                        <p className="text-white/80 text-sm mb-4">
                          Our team is here for you. Get personalized assistance with bookings, treatments, or any questions.
                        </p>
                        <div className="flex flex-wrap gap-2">
                          <a
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 bg-white text-[#7B2D8E] text-sm font-medium rounded-lg hover:bg-white/90 transition-colors"
                          >
                          ...
                          <a
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 bg-white/20 text-white text-sm font-medium rounded-lg hover:bg-white/30 transition-colors"
                          >
