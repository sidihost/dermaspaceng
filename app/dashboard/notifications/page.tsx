      ...
      <main className="min-h-screen bg-gray-50">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 md:py-10">
          ...
          <div className="mb-6">
            <Link
              href="/dashboard"
              className="inline-flex items-center gap-1.5 text-sm text-gray-600 hover:text-[#7B2D8E] transition-colors mb-3"
            >
            ...
            <div className="flex items-start justify-between gap-4">
              ...
              {unread > 0 && (
                <button
                  type="button"
                  onClick={markAll}
                  className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-[#7B2D8E] bg-[#7B2D8E]/10 hover:bg-[#7B2D8E]/15 rounded-full transition-colors"
                >
