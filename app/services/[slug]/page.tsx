...
const servicesData: Record<string, {
  ...
  'body-treatments': {
    ...
    treatments: [
      { name: 'Deep Tissue Massage', duration: '60 mins', price: '42,000', description: 'Targets deep muscle tension and chronic pain. Couple from N76,000', popular: true },
      { name: 'Swedish Massage', duration: '60 mins', price: '40,000', description: 'Classic relaxation massage with long, flowing strokes. Couple from N73,000', popular: true },
      { name: 'Hot Stone Massage', duration: '90 mins', price: '60,000', description: 'Heated stones placed along key points for deeper relaxation' },
      { name: '4 Hands Massage (DTM/Swedish)', duration: '45 mins', price: '55,000', description: 'Two therapists working in unison. DTM from N60,000' },
      { name: 'Pregnancy Massage', duration: '70 mins', price: '50,000', description: 'Safe, soothing massage for expectant mothers' },
      { name: 'New Mum / Post-Partum Massage', duration: '60 mins', price: '50,000', description: 'Restorative massage for new mothers' },
      { name: 'Detox Body Scrub + Steam (Salt/Sugar)', duration: '45 mins', price: '42,000', description: 'Exfoliating scrub followed by a detoxifying steam' },
      { name: 'Detox Coffee Body Scrub', duration: '45 mins', price: '45,000', description: 'Stimulating coffee-grain scrub for firmer, smoother skin' },
      { name: 'Dermaspace Body Glow', duration: '60 mins', price: '50,000', description: 'Signature body-brightening treatment from neck to toe' },
      { name: 'Wooden Lymphatic Drainage Massage', duration: '60 mins', price: '70,000', description: 'Traditional wood-therapy lymphatic drainage' },
      { name: 'Hammam Scrub', duration: '90 mins', price: '100,000', description: 'Traditional Moroccan hammam ritual' },
      { name: 'Hammam Glow', duration: '90 mins', price: '120,000', description: 'Premium hammam ritual finished with a glow-boosting body mask' },
      { name: 'Back, Head & Shoulder Massage', duration: '30 mins', price: '25,000', description: 'Focused massage on the most stress-prone areas' },
      { name: 'Reflexology / Foot Massage', duration: '30 mins', price: '25,000', description: 'Pressure-point therapy on the feet' },
      { name: 'Steam', duration: '20 mins', price: '30,000', description: 'Stand-alone detoxifying steam session' },
    ],
  },
  'facial-treatments': {
    ...
    treatments: [
      { name: 'Deep Cleansing Facial', duration: '60 mins', price: '42,000', description: 'Thorough cleansing and extraction. Couple from N78,000', popular: true },
      { name: 'Acne Facial', duration: '60 mins', price: '46,000', description: 'Targeted treatment for acne-prone skin' },
      { name: 'Acne Facial with Extraction', duration: '90 mins', price: '50,000', description: 'Extended acne facial with thorough manual extractions' },
      { name: 'Detoxifying Facial for Acne-Prone Skin', duration: '70 mins', price: '80,000', description: 'Deep detoxifying protocol for active acne' },
      { name: 'Signature Facial Rejuvenation', duration: '60 mins', price: '55,000', description: 'Our signature rejuvenating treatment', popular: true },
      ...
      { name: 'Rejuvenating Hydra Facial', duration: '90 mins', price: '120,000', description: 'Premium hydra facial with rejuvenating boosters' },
      { name: 'Microneedling / Hydra Microneedling', duration: '120 mins', price: '190,000', description: 'Collagen-induction therapy. Hydra Microneedling from N240,000' },
      { name: 'Dermaplaning Add-On', duration: '30 mins', price: '30,000', description: 'Add-on physical exfoliation for smoother skin' },
      { name: 'Consultation', duration: '90 mins', price: '25,000', description: 'One-on-one skin assessment with our therapists' },
    ],
  },
  'nail-care': {
    title: 'Nail Care',
  ...
  'waxing': {
    ...
    treatments: [
      { name: 'Eyebrow Wax', duration: '30 mins', price: '12,000', description: 'Shaped eyebrow waxing. Male from N15,000' },
      { name: 'Chin Wax', duration: '30 mins', price: '10,000', description: 'Quick chin waxing. Male from N15,000' },
      { name: 'Upper Lip Wax', duration: '10 mins', price: '5,000', description: 'Fast upper-lip waxing' },
      { name: 'Underarm Wax', duration: '15 mins', price: '10,000', description: 'Quick, comfortable underarm waxing. Male from N12,000', popular: true },
      { name: 'Full Face Wax', duration: '30 mins', price: '20,000', description: 'Complete facial waxing' },
      { name: 'Full Arm Wax', duration: '30 mins', price: '25,000', description: 'Complete arm hair removal. Male from N30,000' },
      { name: 'Half Arm Wax', duration: '30 mins', price: '15,000', description: 'Half-arm waxing. Male from N20,000' },
      { name: 'Full Leg Wax', duration: '45 mins', price: '35,000', description: 'Complete leg hair removal. Male from N45,000', popular: true },
      { name: 'Half Leg Wax', duration: '30 mins', price: '20,000', description: 'Lower leg waxing. Male from N25,000' },
      { name: 'Back Wax', duration: '30 mins', price: '15,000', description: 'Full back waxing. Male from N20,000' },
      { name: 'Bikini Bottom Wax', duration: '30 mins', price: '22,000', description: 'Lower bikini-area waxing. Male from N30,000' },
      { name: 'Brazilian / Hollywood Wax', duration: '40 mins', price: '30,000', description: 'Brazilian from N30,000, Hollywood from N33,000. Male from N40,000', popular: true },
      { name: 'Hollywood / Brazilian + Underarm Wax', duration: '45 mins', price: '36,000', description: 'Combo waxing service. Male from N50,000' },
      { name: 'Full Body Wax', duration: '120 mins', price: '90,000', description: 'Complete body hair removal. Male from N100,000' },
    ],
  },
}
