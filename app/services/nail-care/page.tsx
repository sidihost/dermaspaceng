...
import { Clock, ArrowRight, ArrowLeft, Flame, Sparkles, Hand, Footprints, Gem } from 'lucide-react'
      ...
      <section className="relative py-20 md:py-28 bg-[#7B2D8E] overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-white/15 backdrop-blur-sm border border-white/25 mb-6">
            <span className="text-xs font-semibold text-white uppercase tracking-[0.2em]">Beauty</span>
          </div>
      ...
      <section className="py-16 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-5 max-w-md mx-auto">Choose from our range of nail care services</p>
          </div>
