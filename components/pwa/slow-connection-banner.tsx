...
export function SlowConnectionBanner() {
  ...
  return (
    <div className="fixed top-4 left-4 right-4 sm:left-1/2 sm:right-auto sm:-translate-x-1/2 z-[80] animate-in fade-in slide-in-from-top-2 duration-300">
      <div className="bg-white border border-[#7B2D8E]/20 rounded-lg px-3 py-2.5 shadow-lg flex items-center gap-2.5">
        ...
        <button
          ...
          className="p-1 hover:bg-[#7B2D8E]/5 rounded transition-colors flex-shrink-0"
          aria-label="Dismiss"
        >
