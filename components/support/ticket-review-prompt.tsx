...
export function TicketReviewPrompt({
  ...
  const submittedCard = useMemo(() => {
    ...
    return (
      <div
        className="rounded-2xl border border-emerald-100 bg-gradient-to-br from-emerald-50 to-white p-5 sm:p-6"
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <button
              ...
              className="mt-3 text-xs font-medium text-emerald-700 hover:text-emerald-900 underline-offset-2 hover:underline"
            >
              Edit my review
            </button>
          </div>
    ...
    >
      <div className="flex items-start gap-4 mb-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-sm text-gray-600 mt-1">{subhead}</p>
        </div>
      </div>

      {/* Star strip — generous tap targets, big enough to feel like
          a real rating, not a checkbox. */}
      <div
        className="flex items-center justify-center gap-2 sm:gap-3 mb-5 select-none"
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <button
          ...
          className="ml-auto inline-flex items-center gap-2 px-5 py-2.5 bg-[#7B2D8E] text-white text-sm font-medium rounded-lg hover:bg-[#6B2278] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {submitting ? (
            <>
