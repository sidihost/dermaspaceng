  ...
  return (
    <div
      className={cn(
        ...
        variant === 'featured' && 'bg-gradient-to-br from-[#7B2D8E] to-[#5A1D6A] text-white',
        variant === 'interactive' && 'bg-white/95 backdrop-blur-sm border border-white/50',
        // Hover effects
        hoverEffect && variant !== 'featured' && 'hover:border-[#7B2D8E]/50',
        hoverEffect && variant === 'featured' && 'hover:scale-105',
        // Interactive
