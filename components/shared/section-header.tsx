...
export default function SectionHeader({ 
  ...
  return (
    <div className={`mb-10 sm:mb-12 md:mb-16 ${centered ? 'text-center' : ''}`}>
      {badge && (
        <div className={`inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-4 sm:mb-5 ${
          light 
      ...
      <h2 className={`text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold font-serif ${light ? 'text-white' : 'text-gray-900'}`}>
        {title}
        {highlight && (
      ...
      {description && (
        <p className={`mt-3 sm:mt-4 max-w-2xl text-sm sm:text-base md:text-lg leading-relaxed ${
