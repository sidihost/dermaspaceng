        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#7B2D8E] transition-colors group"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="tel:+2349017972919" className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-[#7B2D8E] transition-colors">
                  <Phone className="w-4 h-4 text-[#7B2D8E]" />
                  +234 901 797 2919
                </a>
              </li>
              <li>
                <a href="mailto:info@dermaspaceng.com" className="flex items-center gap-2.5 text-sm text-gray-600 hover:text-[#7B2D8E] transition-colors">
