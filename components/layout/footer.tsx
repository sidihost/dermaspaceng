...
export default function Footer() {
  return (
    <footer className="bg-[#FDFBF9] border-t border-gray-100">
      <div className="max-w-6xl mx-auto px-4 py-14 md:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-10 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-2 lg:mb-0">
            ...
            <p className="text-sm font-semibold text-gray-800 mb-4">Follow us on social media</p>
            <div className="flex items-center gap-3">
              <a
                href="https://instagram.com/dermaspace.ng"
                target="_blank"
                rel="noopener noreferrer"
                className="w-11 h-11 rounded-xl bg-[#7B2D8E]/10 flex items-center justify-center hover:bg-[#7B2D8E] transition-colors group"
                aria-label="Instagram"
              >
                <svg className="w-5 h-5 text-[#7B2D8E] group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-2.5 mt-8">
              <div className="flex items-center gap-1">
                ...
                <span className="w-4 h-4 rounded-full bg-white border-2 border-gray-200" />
              </div>
              <span className="text-sm font-medium text-gray-700">Built in Nigeria</span>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3.5">
              {[
                ...
                <li key={link.name}>
                  <Link href={link.href} className="inline-flex items-center gap-2 text-base text-gray-600 hover:text-[#7B2D8E] transition-colors">
                    {link.name}
                    {link.badge && (
                      <span className="px-2 py-0.5 text-[10px] font-bold bg-[#D4A853] text-white rounded-md">
                        {link.badge}
                      </span>
                    )}
                  </Link>
          ...
          {/* Contact */}
          <div>
            <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-5">Contact</h3>
            <ul className="space-y-4">
              ...
              <li>
                <a href="mailto:info@dermaspaceng.com" className="flex items-center gap-3 text-base text-gray-600 hover:text-[#7B2D8E] transition-colors">
                  <Mail className="w-4 h-4 text-[#7B2D8E] flex-shrink-0" />
        ...
        <div className="mt-14 pt-8 border-t border-gray-200">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-gray-500">
              © {new Date().getFullYear()} Dermaspace Esthetics & Wellness. All rights reserved.
            </p>
            <div className="flex items-center gap-6 text-sm text-gray-500">
              <Link href="/privacy" className="hover:text-[#7B2D8E] transition-colors">Privacy Policy</Link>
              <Link href="/terms" className="hover:text-[#7B2D8E] transition-colors">Terms of Service</Link>
            </div>
          </div>
        </div>
      </div>
