      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8 pb-12 border-b border-white/10">
          ...
          <div className="flex flex-wrap gap-3">
            <Link 
              href="/booking"
              className="inline-flex items-center gap-2 px-6 py-3 bg-white hover:bg-white/90 text-[#7B2D8E] text-sm font-semibold rounded-full transition-colors"
            >
              Book Appointment
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12 py-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="tel:+2349017972919" className="flex items-center gap-3 text-sm text-white/70 hover:text-white transition-colors">
                  <Phone className="w-4 h-4 text-white" />
                  +234 901 797 2919
                </a>
              </li>
              <li>
                <a href="mailto:info@dermaspaceng.com" className="flex items-center gap-3 text-sm text-white/70 hover:text-white transition-colors">
        ...
        {/* Locations */}
        <div className="grid sm:grid-cols-2 gap-4 py-8 border-t border-white/20">
          <div className="flex items-start gap-4 p-4 rounded-2xl bg-white/10">
            ...
            <div>
              ...
              <p className="text-sm text-white/70">237B Muri Okunola Street, Victoria Island, Lagos</p>
              <a href="tel:+2349061836625" className="text-sm text-white hover:underline mt-1 inline-block">+234 906 183 6625</a>
            </div>
          </div>
          <div className="flex items-start gap-4 p-4 rounded-2xl bg-white/10">
            <div className="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <p className="text-sm text-white/70">44A, Awolowo Road, Ikoyi, Lagos</p>
              <a href="tel:+2349013134945" className="text-sm text-white hover:underline mt-1 inline-block">+234 901 313 4945</a>
            </div>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-white/20">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-3">
              <span className="text-sm text-white/70 mr-2">Follow Us</span>
              <a
