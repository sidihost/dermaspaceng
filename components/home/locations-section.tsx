...
const InteractiveMap = dynamic(() => import('./interactive-map'), {
  ...
  loading: () => (
    <div
      className="w-full rounded-2xl ring-1 ring-gray-200 bg-gray-50 flex items-center justify-center"
      style={{ height: 420 }}
    >
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-gray-600 max-w-md mx-auto text-pretty">
            {isPersonalised
              ? `${user?.firstName ? user.firstName + ', we' : 'We'}'ve set ${primary.name} as your preferred spa. Directions, hours, and bookings are tailored to this location.`
        ...
        {isPersonalised ? (
          <div className="space-y-4">
            {/* Featured — user's preferred branch */}
            <div className="bg-white rounded-2xl border border-[#7B2D8E]/20 overflow-hidden shadow-sm ring-1 ring-[#7B2D8E]/10">
              <div className="grid md:grid-cols-2">
                ...
                <div className="relative h-48 md:h-auto md:min-h-[240px]">
                  ...
                  <img
                    ...
                    loading="lazy"
                  />
                  <div className="absolute top-3 left-3 inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-[#7B2D8E] text-white text-[10px] font-semibold uppercase tracking-widest shadow-lg">
                ...
                <div className="p-5 md:p-6 flex flex-col">
                  <p className="text-xs font-semibold text-[#7B2D8E] uppercase tracking-widest mb-1">
                    Dermaspace
                  </p>
                  ...
                  <ul className="space-y-2 mb-5">
                    ...
                    <li className="flex items-center gap-2.5 text-sm text-gray-600">
                      <Phone className="w-4 h-4 text-[#7B2D8E] flex-shrink-0" />
                      <a href={`tel:${primary.phone}`} className="hover:text-[#7B2D8E] transition-colors">
                        {primary.phone}
                      </a>
                    </li>
                    <li className="flex items-center gap-2.5 text-sm text-gray-600">
                      <Clock className="w-4 h-4 text-[#7B2D8E] flex-shrink-0" />
                  ...
                  <div className="flex flex-wrap gap-2 mt-auto">
                    <Link
                      ...
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-white bg-[#7B2D8E] rounded-lg hover:bg-[#6B2278] transition-colors"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 px-3.5 py-2 text-xs font-semibold text-[#7B2D8E] bg-[#7B2D8E]/10 rounded-lg hover:bg-[#7B2D8E]/20 transition-colors"
                    >
            ...
            {/* Live animated map — auto-centers on the user's preferred branch */}
            <InteractiveMap
          ...
          <>
            {/* Unpersonalised default: two cards + full map below */}
