  ...
  return (
    <section className="py-16 md:py-24 bg-[#F8F2FB] overflow-hidden">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {/* CTA Buttons */}
        <div className={`flex flex-col gap-3 mt-8 max-w-sm mx-auto md:mx-0 transition-all duration-700 delay-300 ${animateIn ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <a
            href="tel:+2349017972919"
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#7B2D8E] text-white rounded-lg text-sm font-semibold hover:bg-[#6B2D7E] transition-colors"
          >
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white text-[#7B2D8E] border border-[#7B2D8E] rounded-lg text-sm font-semibold hover:bg-[#7B2D8E]/5 transition-colors"
          >
